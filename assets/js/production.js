...
jQuery( document ).ready( function( $ ) {
	...
	========================================================================== */
		...
		var $login = $('#login'),
		$loginlink = $('.login-toggle');

		$loginlink.click(function(e) {
			e.preventDefault();
			$loginlink.toggleClass('login-toggle--active');
			$login.toggleClass('header__login--active');

			$menulink.removeClass('nav-toggle--active');
			$menu.removeClass('menu--main--active');
		});
	...
	/* ==========================================================================
		//MAGNIFICANT POPUP
		//Code for the Magnific Popup for the Gallery Scripts.
		//Code Obtained from http://dimsemenov.com/plugins/magnific-popup/
	========================================================================== */
		$('.gallery').magnificPopup({
			delegate: '.gallery-magpop',
			type: 'image',
			closeOnContentClick: false,
			...
			image: {
				...
				titleSrc: function(item) {
					return item.el.attr('title') + '<p>' + item.el.data('description') + '</p>';
				},
